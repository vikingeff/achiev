...
<?php
	header('Location: ../client.php?menu=2');
	session_start();
	...
	<div class="content">
		<form method="post">
			<p>
				...
				<input type="text" name="titre" id="titre" size="58"/>
				</br></br>
				<label for="mtype">Type de la mission: </label>
				<select name="mtype"  width="410" style="width: 410px"> 
				...
				<input type="text" id="datepicker" name="datepicker" size="58">
				</br></br>
				...
				<?php
					...
					mysqli_close($con);
					?>
				<input type="text" name="propo" id="propo" size="58" value="<?php echo $proprice; ?>" disabled/>
				</br></br>
				<label for="price">Votre tarif : </label>
				<input type="text" name="price" id="price" size="58"/>
				</br></br>
				<input type="submit" name="submit" value="Enregistrer la mission"/>
			</p>
		</form>
	</div>