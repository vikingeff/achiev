<?php include("includes/header.php"); ?>
	...
	<div id="subheader">
		...
		<div class="schoix">DÉPOSEZ UNE OFFRE</div>
		<br/><br/>
		<img src="img/trait.png" width=25px; /><br /><br/>
		10 524 <p>OFFRES</p>
		<br/><br/>
		<img src="img/trait.png" width=25px; /><br />
	</div>

	<p id="subtitle">GRACE à ACHIEV...</p>
	<div class="content">
		<span class="picture"> </span><br/>
		<span class="insight">"J'ai immédiatement eu une <p>mission rémunérée</p> qui correspondait réellement à <p>mes compétences</p>"</span>
	</div>

	<p id="subtitle"><br/><br/>UN MONDE DE COMPÉTENCES S’OFFRE À VOUS</p>
	<div class="content">
		<h1>EXEMPLES DE MISSIONS</h1>
		<div id="xmiss">
		<div class="exmission">
			<h2>
			<img src="img/Info-clair.png" /><br/>
			INFORMATIQUE
			</h2>
			<ul>
				...
				<img class="trait" src="img/trait.png" />
				<li>METTRE EN RÉSEAU<br/>UN PARC INFORMATIQUE</li>
			</ul>
		</div>
		<div class="exmission">
			<h2>
			<img src="img/Design-clair.png" /><br/>
			ARTS APPLIQUÉS
			</h2>
			<ul>
				<li>CONCEVOIR<br/>UNE IDENTITÉ VISUELLE</li>
				<img class="trait" src="img/trait.png" />
				<li>COMPOSER<br/>UNE ANIMATION 3D</li>
				<img class="trait" src="img/trait.png" />
				<li>ÉLABORER UN PLAN<br/>ARCHITECTURAL</li>
			</ul>
		</div>
		<div class="exmission">
			<h2>
			<img src="img/Business-clair.png" /><br/>
			BUSINESS
			</h2>
			<ul>
