<?php include("includes/header.php"); ?>
	...
	<p id="subtitle">GRACE A ACHIEV...</p>
	<div class="content">
		<span class="picture"> </span><br/>
		<span class="insight">J'ai immediatement eu une <p>mission remuneree</p> qui correspondait reellement a <p>mes competences</p></span>
	</div>

	<p id="subtitle"><br/><br/>UN MONDE DE COMPÉTENCES S’OFFRE À VOUS</p>
	<div class="content">
		<h1>EXEMPLE DE MISSIONS</h1>
		<div id="xmiss">
		<div class="exmission">
			<h2>
